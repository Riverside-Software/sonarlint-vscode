...
suite('IdeLabsFlagManagementService', () => {
  ...
  test('enables IDE Labs', async () => {
    ...
    expect(globalStateUpdateStub.calledWith('sonarqube-abl.ideLabsEnabled', true)).to.be.true;
  ...
  test('disables IDE Labs', async () => {
    ...
    expect(globalStateUpdateStub.calledWith('sonarqube-abl.ideLabsEnabled', false)).to.be.true;
